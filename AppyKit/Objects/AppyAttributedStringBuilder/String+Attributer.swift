...
public extension String {
     ...
     */
    public func attributerAppend(_ string: String) -> Attributer {
     ...
     */
    public func attributerAppend(_ attributedString: NSMutableAttributedString) -> Attributer {
     ...
     */
    public func attributerAppend(_ attributer: Attributer) -> Attributer {
